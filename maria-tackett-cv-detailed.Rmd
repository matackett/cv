...
18. **Tackett, M.**, Roith, J. *Teaching Probability and Probability
    Distributions.*

19. Viel, S., **Tackett, M.**, Das, S., Choo, J.\*. *Classroom Community
...
20. Rubin, N\*, **Tackett, M**., Çetinkaya-Rundel, M., Meyer, E.
    ...
    STEM Education*.
21. **Tackett**, M., Cellini, B.\*, Ralph, M.\*, Huynh, L.\*, Tang, B.,
...
22. Easter, M., Schramm-Sapyta, N., Swartz, M., **Tackett, M.**,
    ...
    one southeastern U.S. county jail 2014-2020. Submitted to *PLOS
    ONE*.

## Publications: In Preparation

1.  **Tackett, M.** *Introduction to Regression Analysis: A Data Science
    Approach*. Expected 2026. (Under contract with Chapman and Hall/CRC
    Press).
2.  Schramm-Sapyta, N., Larsen, I.\*, Pandey, M.\*, Feng, W.\*, Tang,
...
1.  Viel, S., Tackett, M. *Classroom Community in Introduction
    Undergraduate Mathematics and Statistics.* The Converging Challenges
    for Inclusive Education. Online. July 2024.

2.  Tackett, M., *Using Quarto for Making and Organizing Teaching
...
4.  Tackett, M., Çetinkaya-Rundel, M., Presman, R. *Modernizing the
...
6.  Tackett, M. *Version control as a learning objective in statistics
    and data science courses*. 63rd World Statistics Congress. Online.
    July 2021.

7.  Horton, N., Tackett, M. *GitHub and intro stats: technology to
    support group and project-based learning*. USCOTS. Online.
    July 2021. (Poster)

8.  Tackett, M., Li, S. Mokel, M., Tian, S. *Developing Interactive
    Statistics Apps: A look at the project and student experience*.
    USCOTS. Online. July 2021. (Poster)

9.  Tackett, M. *You don't have to be an expert to create something
...
Mathematically Gifted and Black <!--# Fill in the details-->
...
-   Invited to join small team to develop course design principles and
    learning objectives for high school data science courses

UT-Austin Dana Center Statistics Curriculum Authoring Group, 2021

-   Group of 20 authors writing lessons for an introductory statistics
    course.
-   Describe what as included in each lesson.
-   Invited to join 2-persont team to develop projects and corresponding
    rubrics for introductory statistics.
-   Link to find the curriculum? Something about how widely it's used?

UT-Austin Dana Center Statistics Curriculum Advisory Group, 2020

-   Developed course design principles for introductory data courses (?)
    is this correct?

Howard Hughes Medical Institute Data Exploration Course Advisory
Committee, 2020 - 2021

<!--# add something about what I've done here-->
...
-   Part of small team revising the GAISE guidelines and report for
    expected release in 2025

-   Writing learning objectives for undergraduate introductory
    statistics courses

-   Part of subteam writing guidelines for undergraduate introductory
    data science

-   Part of team leading the writing for the revised report
...
-   Meets quarterly to provide feedback and advise on development of
    courseware for introductory statistics and chemistry courses
...
<!--# Feedback from Amy: Split this up into Service to Duke University and Service to the Department of Statistical Science-->

College Advisor, 2022 - present

-   Pre-major advisor for X <!--# Include the number--> undergraduate
...
-   Advisor for X <!--# Include total number--> Master's students

Duke SPIRE Mentor, 2019 - present

Statistical Science Undergraduate Major Advisor, 2018 - present

-   Major advisor for X <!--# include number--> students in the
    statistical science major and IDMs
