...
18. Easter, M., Schramm-Sapyta, N., Swartz, M., **Tackett, M.**,
...
19. **Tackett, M.**, Roith, J. Teaching Probability and Probability
    Distributions*. STAT Prep.* MAA Notes. Mathematical Association of
    America. <!--# add an expected by date-->

20. Viel, S., **Tackett, M.**, Das, S., Choo, J.\*. *Classroom Community
...
22. **Tackett, M.** *Introduction to Regression Analysis: A Data Science
...
Team, 2023 - present <!--# what is a better name to call this? -->
...
-   Developed course design principles for introductory statistics
    courses
...
## Service to Department of Statistical Science
