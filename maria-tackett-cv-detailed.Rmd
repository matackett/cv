...
21. Rubin, N\*, **Tackett, M**., Çetinkaya-Rundel, M., Meyer, E.
    ...
    STEM Education*.
22. Schramm-Sapyta, N., Larsen, I.\*, Pandey, M.\*, Feng, W.\*, Tang,
...
23. **Tackett, M.**, Cellini, B.\*, Ralph, M.\*, Huynh, L.\*, Tang, B.,
...
24. **Tackett, M.** *Introduction to Regression Analysis: A Data Science
    Approach*. Expected 2026. (Under contract with Chapman and Hall/CRC
    Press).
25. Hart, F., **Tackett, M.**, Purohit, S., Schramm-Sapyta, N. A
    meta-analysis of medication-assisted treatment initiated in carceral
    settings: Six months post-release.
...
\end{itemize}
```
Bill & Melinda Gates Foundation High School Math Pathways Data Science
Group Team, 2023 - 2024
