...
1.  Tackett, M. [*Teaching intro data
    science*](https://matackett.github.io/talks/presentations/teach-data-science.pdf)*.*
    Preparing to Teach. George Mason University. August 2022.

2.  Tackett, M. [*Knit, Commit, and Push: Teaching version control in
    undergraduate statistics
    courses*](https://maria-tackett.netlify.app/talk/teach-version-control/).
    Toronto Workshop on Reproducibility. Online. February 2022.

3.  Tackett, M.[*Mentoring Undergraduate Research: Creating productive
    experiences and sharing student
    work*](https://maria-tackett.netlify.app/talk/mentor-undergrad-research/).
    ASA Mentoring Undergraduate Research Panel. Online. February 2022.
    (Panelist)
...
6.  Tackett, M. [*Building Websites in
    RStudio*](https://github.com/matackett/rladies-build-websites/blob/main/rladies-build-websites.pdf).
    RLadies Baltimore. Online. April 2021.

7.  Tackett, M. [*Building Websites in
    RStudio*](https://github.com/matackett/rladies-build-websites/blob/main/rladies-build-websites.pdf).
    RLadies Amherst. Online. March 2021.

8.  Tackett, M. *Telling stories with data.* Abraham Lincoln High
    School. Online (Philadelphia, PA). January 2021.

9.  Tackett, M. [*Undergraduate research in
    statistics*](https://matackett.github.io/talks/presentations/ourfa2m2-dec2020.pdf)*.*
...
13. Tackett, M. [*Who's Underrepresented? Modeling Undercounts in the
    U.S.
    Census*](https://matackett.github.io/talks/presentations/tackett-census-jsm-2020-present.pdf).
    Joint Statistical Meeting. Online. August 2020.
...
15. Tackett, M. [*You don't have to be an expert to create something
    meaningful*](https://matackett.github.io/talks/presentations/rladies-lightning-tackett.pdf).
    rstudio::conf. San Francisco, CA. January 2020.
...
18. Tackett, M. [*Statistics in
    Practice*](https://matackett.github.io/talks/presentations/focus-oct2019.pdf).
    FOCUS Cluster Dinner Series at Duke University: What if? Explaining
    the Past/Predicting the Future. Durham, NC. November 2019.

19. Tackett, M. [*Beyond the Buzzword: A Look at Data Science in
    Practice and How You Can Be a Part of
    It*](https://matackett.github.io/talks/presentations/samsi-talk-oct2019.pdf).
    SAMSI Diversity in Data Science and Machine Learning Conference.
    Washington, DC. October 2019. (Plenary talk)
...
1.  Tackett, M., Viel, S. [*Undergraduate Students' Sense of Community
    in Introductory Math and Statistics
    Courses*](https://maria-tackett.netlify.app/talk/socqs-ecots22/).
    eCOTS. Online. May 2022.

2.  Tackett, M., Çetinkaya-Rundel, M., Presman, R. [*Modernizing the
    undergraduate regression analysis
    course*](https://maria-tackett.netlify.app/talk/ecots-modern-regression/).
    eCOTS. Online. May 2022.

3.  Tackett, M., Viel, S. [*Undergraduate Students' Sense of Community
    in Introductory Math and Statistics
    Courses*](https://maria-tackett.netlify.app/talk/socqs-pandemic-pedagogy/).
    Pandemic Pedagogy Research Symposium. Online. May 2022.
...
1.  **Tackett, M.**, Viel, S., Manturuk, K. (in press). A validation of
...
2.  Fannina, D., Ellebya, J., **Tackett, M.**, Minga, J. (in press).
...
2.  **Tackett, M.**, Roith, J. Teaching Probability and Probability
    Distributions. *MAA Notes Volume on STATPrep.*

3.  Book chapter with Shira
...
6.  Schramm-Sapyta, N., Ralph, M.\*, Huynh, L.\*, Tang, B.\*, **Tackett,
    M.**, Easter, M., Larsen, I.\* (2021) Role of substance use and
    mental illness diagnosis in rearrest in a county detention facility.
...
2.  **Tackett, M.** (2021, January 14). [*A flipped classroom sparks
    online
...
3.  **Tackett, M.**, & Çetinkaya-Rundel, M. (2020). COVID-19 Data in the
    Classroom. *CHANCE*, 33(3), 63-66.

4.  **Tackett, M.** (2020, July 23). [*Creating Interactive Web Apps for
    Statistics*](https://muser.duke.edu/blog/creating-interactive-web-apps-statistics).
    Duke Musings Blog.

5.  Çetinkaya-Rundel, M., & **Tackett, M.** (2020). From drab to fab:
    Teaching visualization via incremental improvements. *CHANCE*,
    33(2), 31-41.

6.  Banks, D., **Tackett, M.** (2020). Bayesian Methods and Forensic
    Evidence. In Banks, D., Kafadar, K., Kaye, D., Tackett, M. (Eds.),
    *Handbook of Forensic Statistics* (pp. 73 - 90), Chapman & Hall.

7.  Banks, D., Kafadar, K., Kaye, D., **Tackett, M.** (Eds.), *Handbook
...
Developed the first generation of statistical models to perform deposit forecasts for Capital One Bank. \vspace{8pt}
